...
def check_args (stages, players, name):
	...
	if (correct_stages and correct_players):
		if name == "":
			print("The value given for -n or --name must exist.")
			start_client = False
		else:
			start_client= True
		return start_client
...
try:
	...
	start_client = check_args(stages, players, name)
	port = int(port)
	if (start_client):
		exit = False
	...
	print("The port you want to access does not exist.")
except getopt.GetoptError:
	print("A value given requires argument.")
except :
	print("The server has been shut down. The game finished. Nobody wins.")