...
def recv_one_message(sock):
	...
	if player_game.current_turn >= player_game.players:#len(player_game.characters):
				...
				if player_game.characters_dead():
					...
					case_player_dead(player_game, end)
			else:
				print("el turno es el ",player_game.current_turn)
				case_player_dead(player_game, end)
				...
				def case_player_dead(player_game, end):
		for i in player_game.turnos_muertos:
		print(i)
		if int(i) == (player_game.current_turn):
			print("pepe")
			player_game.next_turn()
	if player_game.current_turn >= player_game.players:
		send_enemies_damage(player_game)
		if player_game.characters_dead():
			send_end_game(player_game, False)
			end = True
	...
	print("el turno empieza entonces es el: ",player_game.current_turn)
